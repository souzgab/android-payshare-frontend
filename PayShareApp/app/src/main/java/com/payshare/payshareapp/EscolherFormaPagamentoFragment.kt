    ...
    override fun onCreateView(
        ...
        conn.wallet().findCard(card).enqueue(object : Callback<PaymentFindCardResponse>{
            override fun onResponse(
                ...
                Log.println(Log.INFO, "asdfsd", response.body().toString())
        ...
        view.findViewById<RadioGroup>(R.id.rd_typePagamentoPre).setOnCheckedChangeListener { radioGroup, i ->
            ...
            when(radioGroup.checkedRadioButtonId) {
               R.id.cartao -> {
                   view.findViewById<TextView>(R.id.et_nomeCartaoPre).visibility = View.GONE
                ...
                findUserById.findUserById(it, "Bearer $token")
                    .enqueue(object : Callback<UserResponse> {
                        override fun onResponse(
                            ...
                            //TODO - trocar o pagamento de acordo com o radio
                            if (data != null) {
                                    ...
                                    transaction.paymentWalletLobby(
                                        ...
                                        .enqueue(object : Callback<TransactionResponse> {
                                            override fun onResponse(
                                                ...
                                                var data = response.body()
                                                if (data != null) {
                                                    Log.e("Sucesso", "teste pagamento" + Gson().toJson(data))
                                                    Toast.makeText(
                                                        context,
